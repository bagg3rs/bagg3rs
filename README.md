...
- [bagg3rs/nas-synology](https://github.com/bagg3rs/nas-synology) - Things I did with my Synology NAS (2 days ago)
...
- **[awslabs/LISA](https://github.com/awslabs/LISA)** - LLM inference solution for Amazon Dedicated Cloud (LISA).  (1 day ago)
