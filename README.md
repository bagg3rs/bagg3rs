...
- **[chrisurf/obsidian-voice](https://github.com/chrisurf/obsidian-voice)** - 🔊 The Obsidian Voice plugin to listening to your written content being read aloud.  (3 weeks ago)
- **[wulkano/Kap](https://github.com/wulkano/Kap)** - An open-source screen recorder built with web technology (1 month ago)
